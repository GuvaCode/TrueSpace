...
const
 SHADOWMAP_VS_FILE = 'depthMap.vs';
 SHADOWMAP_FS_FILE = 'depthMap.fs';
 MODEL_VS_FILE = 'model.vs';
 MODEL_FS_FILE = 'model.fs';
 DEPTH_FS_FILE = 'depth.fs';

 SHADOW_CAMERA_POSITION: TVector3 = (x:30.0; y:40.0; z:50.0);
